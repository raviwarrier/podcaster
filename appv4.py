...
def generate_audio(
    ...
    text_model: str = "o1-mini",  # Default model changed to "o1-mini"
    ...
    # Use a temporary file with the title in the filename
...
""") as demo:
    ...
    with gr.Row(elem_id="main_container"):
        ...
        with gr.Column(scale=1):
            ...
            input_type = gr.Radio(
                label="Input Type",
                choices=["URL", "Text", "Markdown", "PDF"],  # Reordered choices
                value="URL",  # Default input type set to "URL"
            ...
            text_model = gr.Dropdown(
                ...
                value="o1-mini",  # Default model set to "o1-mini"
